...
const checkRequiredFiles = require('@eddie/dev-utils/checkRequiredFiles');
const FileSizeReporter = require('@eddie/dev-utils/FileSizeReporter');
const formatWebpackMessages = require('@eddie/dev-utils/formatWebpackMessages');
const printBuildError = require('@eddie/dev-utils/printBuildError');
const printHostingInstructions = require('@eddie/dev-utils/printHostingInstructions');
...
const { checkBrowsers } = require('@eddie/dev-utils/browsersHelper');
