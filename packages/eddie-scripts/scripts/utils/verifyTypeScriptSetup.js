...
const os = require('os');
const immer = require('@eddie/dev-utils/immer').produce;
const globby = require('@eddie/dev-utils/globby').sync;
...
function verifyTypeScriptSetup() {
  ...
  // Reference `eddie-scripts` types
  if (!fs.existsSync(paths.appTypeDeclarations)) {
    fs.writeFileSync(
      paths.appTypeDeclarations,
      `/// <reference types="@eddie/scripts" />${os.EOL}`
    );
  }
}
