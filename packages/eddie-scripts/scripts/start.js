...
const openBrowser = require('@eddie/dev-utils/openBrowser');
const clearConsole = require('@eddie/dev-utils/clearConsole');
...
const {
  ...
  printInstructions,
  createCompiler,
} = require('@eddie/dev-utils/webpackUtils');
...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(port => {
    ...
    clientConfig.entry = [
      `@eddie/dev-utils/webpackHotDevClient?devPort=${devPort}`,
      ...clientConfig.entry,
    ];
