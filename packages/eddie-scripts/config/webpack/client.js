...
const ModuleScopePlugin = require('@eddie/dev-utils/ModuleScopePlugin');
const InlineChunkHtmlPlugin = require('@eddie/dev-utils/InlineChunkHtmlPlugin');
const InterpolateHtmlPlugin = require('@eddie/dev-utils/InterpolateHtmlPlugin');
      ...
      rules: [
        ...
        // It's important to do this before Babel processes the JS.
        {
          ...
          use: [
            {
              options: {
                formatter: require.resolve('@eddie/dev-utils/eslintFormatter'),
